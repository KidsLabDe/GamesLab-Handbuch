...
pandoc all-ebook.tmp -o GamesLab-Handbuch.epub  --from gfm --css=style.css --resource-path=bilder --embed-resources --standalone --epub-embed-font=assets/MarioWorldPixelColor.ttf --epub-embed-font=assets/PixelifySans.ttf
